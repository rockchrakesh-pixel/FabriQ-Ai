...
// Maps screen IDs to permitted user roles. Internal enterprise portals are strictly restricted.
const ROLE_PERMISSIONS: Partial<Record<ScreenId, UserRole[]>> = {
  ...
  'operations-center': ['super_admin', 'ceo', 'owner', 'franchise_owner', 'regional_manager', 'area_manager', 'store_manager', 'store_staff', 'quality_inspector', 'pickup_executive', 'delivery_executive', 'mis', 'finance', 'inventory'],
  'enterprise-analytics': ['super_admin', 'ceo', 'owner', 'franchise_owner', 'regional_manager', 'area_manager', 'store_manager', 'mis', 'finance'],
};
