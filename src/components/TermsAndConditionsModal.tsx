        ...
        <div className="p-6 overflow-y-auto space-y-5 text-slate-700 text-xs leading-relaxed flex-1">
          ...
          <section className="space-y-2">
            <h3 className="font-bold text-sm text-slate-900 flex items-center gap-1.5">
              ...
              Promotional Coupons & Gift Vouchers
            </h3>
            <p>
              Promotional discount coupons and gift vouchers apply to eligible garment care services as specified during booking checkout. Discounts apply to care service subtotals and cannot be combined with non-stackable corporate vouchers or special contract rates.
            </p>
          </section>
