...
const INITIAL_SEED_ORDERS: Omit<Order, 'id'>[] = [
  {
    ...
    branchName: 'Bowenpally Care Atelier',
  ...
  },
  {
    ...
    branchName: 'Suchitra Junction Lounge',
  ...
  },
  {
    ...
    branchName: 'Kompally Care Studio',
...
export const OrderProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(
      ...
      (error) => {
        console.warn('Firestore onSnapshot error for orders, using memory seed:', error);
        setOrders(
          INITIAL_SEED_ORDERS.map((seed, idx) => ({
            ...seed,
            id: `seed-order-${idx + 1}`,
          }))
        );
